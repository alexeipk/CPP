...
/*   Updated: 2022/05/21 22:49:47 by aprotoce         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void){
	...
	Form* formShrub;
	formShrub = createForm(&InternS, "shrubbery creation", "TREE");
	std::cout << *formShrub << std::endl;
	...
	std::cout << "Creating Form-----------------------------------------------------" << std::endl;
	Form* formRobot;
	formRobot = createForm(&InternS, "robotomy request", "BOT");
	std::cout << *formRobot << std::endl;
	std::cout << "Sign and Execute tests--------------------------------------------" << std::endl;
	...
	std::cout << "Creating Form-----------------------------------------------------" << std::endl;
	Form* formPres;
	formPres = createForm(&InternP, "presidential pardon", "Zaphord Beeblebox");
	std::cout << *formPres << std::endl;
	std::cout << "Sign and Execute tests--------------------------------------------" << std::endl;
